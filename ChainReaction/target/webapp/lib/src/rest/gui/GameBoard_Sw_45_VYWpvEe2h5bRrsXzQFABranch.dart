...
class GameBoard_Sw_45_VYWpvEe2h5bRrsXzQFABranch extends ContinueProcessRequest {
	...
	Map<String,dynamic> toJSOG()
	{
		...
		throw new Exception("Exhaustive IF GameBoard_Sw_45_VYWpvEe2h5bRrsXzQFABranch.dart");
	}
}
