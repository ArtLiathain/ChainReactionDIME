...
@Inject de.ls5.dywa.generated.controller.dime__HYPHEN_MINUS__models.app.TileController TileController;
@Inject de.ls5.dywa.generated.rest.controller.TileREST TileREST;
...
public de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Tile transform(de.ls5.dywa.generated.rest.types.Tile o) {
	final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Tile obj;
	if (o.getDywaId() > 0) {
		obj = TileController.read(o.getDywaId());
	}
	 else if (o instanceof de.ls5.dywa.generated.rest.types.Tile) {
		obj = TileREST.copyToTransient((de.ls5.dywa.generated.rest.types.Tile) o);
	}
	 else { throw new java.lang.IllegalArgumentException("Unknown type"); } 
	return obj;
}
