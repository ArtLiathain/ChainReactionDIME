...
private de.ls5.dywa.generated.controller.dime__HYPHEN_MINUS__models.app.TileController tileController;
	...
	public void deleteWithIncomingReferences(Board entityToDelete) {
		...
		// Delete references from type Tile
			de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Tile searchTile;
			searchTile = new de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.TileSearch();	
				searchTile.setboard(entityToDelete);
			for (de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Tile queryResult : this.tileController.findByProperties(searchTile)) {
