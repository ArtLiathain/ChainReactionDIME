...
public class BaseUserSearch implements BaseUser {
	...
	public java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.ConcreteUser> getconcreteUser_ConcreteUser() {
		return (java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.ConcreteUser>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(6L));
	}
	...
	(java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.ConcreteUser> object) {
			...
			this.listAttributeMap.put(dywaIdToJpqlAttr.get(6L), object);
	}
	@java.lang.Override
	...
	public de.ls5.dywa.generated.util.FileReference getimage() {
		return new de.ls5.dywa.generated.util.FileReference((de.ls5.dywa.generated.util.DomainFile) this.attributeMap.get(dywaIdToJpqlAttr.get(8L)));
	}
	...
	(de.ls5.dywa.generated.util.FileReference object) {
			...
			this.attributeMap.put(dywaIdToJpqlAttr.get(8L), object != null ? object.getDelegate() : null);
	}
	@java.lang.Override
