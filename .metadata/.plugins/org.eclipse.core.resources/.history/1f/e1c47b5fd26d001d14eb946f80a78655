...
public class BoardSearch implements Board {
	...
	public java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Tile> gettile_Tile() {
		return (java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Tile>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(12L));
	}
	public void settile_Tile
	(java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Tile> object) {
			
				for(de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Tile p: object){
					 if (! (p instanceof de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Tile)) {
							throw new java.lang.RuntimeException("Wrong type");
				}
				}
			this.listAttributeMap.put(dywaIdToJpqlAttr.get(12L), object);
	}
